    ...
    return (
        ...
        <section className={style.text} >
            ...
            <ul>
                ...
                <li>Easy to Use: Our platform is designed with you in mind. Whether you&apos;researching foraword&apos;s meaning, synonyms, or usage examples, you’ll find everything you need in one place, with a simple, intuitive interface</li>
                <li>Explore and Learn: Every word you look up is an opportunity to learn some thing new. We encourage you to explore the richness of language, expand your vocabulary, and discover the joy that comes from understanding and using new words.</li>
            </ul>
            <h2>A special thanks</h2>
            <p>Without all the amazing work done at the people who made <a href="https://dictionaryapi.dev/">https://dictionaryapi.dev/ none of this would have been possible. Their API is completely free for anyone to develop with and we encourage you to visit their site. So much so, that we have included a direct link to their site in the navigation on this site.</a> </p>
            </article>
        </section>
        </>
    )
